$PBExportHeader$w_report_line_error.srw
$PBExportComments$<Response> list all error for current shift, inherited from pfemain/w_sheet
forward
global type w_report_line_error from w_sheet
end type
type dw_report from u_dw within w_report_line_error
end type
type cb_close from u_cb within w_report_line_error
end type
end forward
...
global w_report_line_error w_report_line_error
...
on w_report_line_error.destroy
call super::destroy
destroy(this.dw_report)
destroy(this.cb_close)
end on

event open;call super::open;Long ll_line, ll_shiftid
...
dw_report.Retrieve(ldt_s, ldt_e, ll_line)
...
integer height = 621
integer taborder = 30
string dataobject = "d_line_shift_error_log"
