$PBExportHeader$w_production_folder_temp.srw
$PBExportComments$documents for current job for shop floor
forward
global type w_production_folder_temp from w_sheet
end type
type cb_shot from u_cb within w_production_folder_temp
end type
type cb_stop from u_cb within w_production_folder_temp
end type
type cb_play from u_cb within w_production_folder_temp
end type
type ole_video from olecustomcontrol within w_production_folder_temp
end type
type cb_print from u_cb within w_production_folder_temp
end type
type st_title3 from statictext within w_production_folder_temp
end type
type st_title2 from statictext within w_production_folder_temp
end type
type cb_as from u_cb within w_production_folder_temp
end type
type cb_open from u_cb within w_production_folder_temp
end type
type em_job from editmask within w_production_folder_temp
end type
type st_title1 from statictext within w_production_folder_temp
end type
type tab_doc from tab within w_production_folder_temp
end type
...
type cb_close from u_cb within w_production_folder_temp
end type
type dw_report from u_dw within w_production_folder_temp
end type
type gb_job from groupbox within w_production_folder_temp
end type
end forward
...
global w_production_folder_temp w_production_folder_temp
...
ELSE
	...
	FROM security_user
	WHERE lower(login_id) = lower(:ls_login)
	USING SQLCA;
...
on w_production_folder_temp.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.cb_shot
this.Control[iCurrent+2]=this.cb_stop
this.Control[iCurrent+3]=this.cb_play
this.Control[iCurrent+4]=this.ole_video
this.Control[iCurrent+5]=this.cb_print
this.Control[iCurrent+6]=this.st_title3
this.Control[iCurrent+7]=this.st_title2
this.Control[iCurrent+8]=this.cb_as
this.Control[iCurrent+9]=this.cb_open
this.Control[iCurrent+10]=this.em_job
this.Control[iCurrent+11]=this.st_title1
this.Control[iCurrent+12]=this.tab_doc
this.Control[iCurrent+13]=this.cb_close
this.Control[iCurrent+14]=this.dw_report
this.Control[iCurrent+15]=this.gb_job
end on

on w_production_folder_temp.destroy
call super::destroy
...
string binarykey = "w_production_folder_temp.win"
integer textsize = -8
integer weight = 400
...
04w_production_folder_temp.bin 3992 

14w_production_folder_temp.bin 3992 
