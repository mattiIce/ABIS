$PBExportHeader$w_office_skid_entry_backup.srw
$PBExportComments$<Sheet> Used in office to input skid information inherited from pfemain/sheet
forward
global type w_office_skid_entry_backup from w_sheet
end type
type dw_prod_order_detail from u_dw within w_office_skid_entry_backup
end type
type cb_close from u_cb within w_office_skid_entry_backup
end type
type st_title1 from u_st within w_office_skid_entry_backup
end type
type st_title# from u_st within w_office_skid_entry_backup
end type
type dw_skid_list from u_dw within w_office_skid_entry_backup
end type
type cb_print from u_cb within w_office_skid_entry_backup
end type
type cb_new from u_cb within w_office_skid_entry_backup
end type
type cb_insert from u_cb within w_office_skid_entry_backup
end type
type cb_delete from u_cb within w_office_skid_entry_backup
end type
type dw_coil_status from u_dw within w_office_skid_entry_backup
end type
type gb_1 from groupbox within w_office_skid_entry_backup
end type
type cb_save from u_cb within w_office_skid_entry_backup
end type
type cb_cancel from u_cb within w_office_skid_entry_backup
end type
type dw_skid_editor from u_dw within w_office_skid_entry_backup
end type
type cb_modify from u_cb within w_office_skid_entry_backup
end type
type cb_refresh from u_cb within w_office_skid_entry_backup
end type
end forward
...
global w_office_skid_entry_backup w_office_skid_entry_backup
...
on w_office_skid_entry_backup.create
int iCurrent
call super::create
...
on w_office_skid_entry_backup.destroy
call super::destroy
