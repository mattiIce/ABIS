...
const dDate = (d) => (d == null ? '' : d.toISOString().slice(0, 10));
...
async function search() {
    ...
    try {
      ...
      <tr class="click" data-id="${j.abJobNum}">
        ...
        document.querySelectorAll('#jobs tr.click').forEach((tr) => tr.addEventListener('click', () => loadJob(Number(tr.dataset.id))));
    }
    catch (e) {
