...
BEGIN
  IF USER <> 'DBO' THEN
    RAISE_APPLICATION_ERROR(-20007,
      'Migration 007 must be applied as DBO, not ' || USER || '. Reconnect with: CONNECT dbo');
  END IF;
END;
/
...
-- Novelis 861 (Kingston 1153 / Oswego 1459 / 2582): SH group, GS sender R0P7A, GS03 receiver 001504935001
-- (≠ ISA08 0015049350011G), version 00401 — verified byte-for-byte against a production golden.
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, gs_receiver_code, file_prefix, item_reference) VALUES (1153, '861', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'SH', 'R0P7A', '001504935001', 'S_Novelis_', NULL);
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, gs_receiver_code, file_prefix, item_reference) VALUES (1459, '861', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'SH', 'R0P7A', '001504935001', 'S_Novelis_', NULL);
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, gs_receiver_code, file_prefix, item_reference) VALUES (2582, '861', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'SH', 'R0P7A', '001504935001', 'S_Novelis_', NULL);
...
-- Novelis 870 (Kingston 1153, Oswego 1459, Guthrie 2950): per-job variant; GS03 receiver (001504935001) ≠ ISA08
-- (0015049350011G). All three plants share F_EDI_NOVELIS_870_4JOB (customer_short_name LIKE '%novelis%'), so
-- Guthrie is identical apart from its own N1*SU DUNS (117061565), which the assembler pulls per job.
...
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_receiver_code, file_prefix, item_reference) VALUES (2950, '870', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'RS', '001504935001', 'S_novelis_870_', NULL);
...
-- Constellium 870 (customer 2776, F_EDI_CONSTELLIUM_BG_870_4JOB): per-COIL variant. Same '@' component separator
-- as its 861, but the 870 proc terminates every segment with '~' (segment_suffix); GS code RS, prefix S_const_870_.
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, file_prefix, item_reference) VALUES (2776, '870', 1, 'constellium', '01', '043207177', '@', '~', '00401', 'RS', NULL, 'S_const_870_', NULL);
-- 856 (ASN) — the three live partners (Novelis Kingston/Oswego/2582, Constellium, Arconic). Each mirrors its
-- 861 envelope with the 856 file prefix + body variant.
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, gs_receiver_code, file_prefix, item_reference) VALUES (1153, '856', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'SH', 'R0P7A', '001504935001', 'S_novelis_856_', NULL);
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, gs_receiver_code, file_prefix, item_reference) VALUES (1459, '856', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'SH', 'R0P7A', '001504935001', 'S_novelis_856_', NULL);
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, gs_receiver_code, file_prefix, item_reference) VALUES (2582, '856', 1, 'novelis', '09', '0015049350011G', '', '', '00401', 'SH', 'R0P7A', '001504935001', 'S_novelis_856_', NULL);
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, file_prefix, item_reference) VALUES (2776, '856', 1, 'constellium', '01', '043207177', '@', '', '00401', 'SH', 'S_constellium_856_', NULL);
INSERT INTO abis_edi_partner (customer_id, transaction_set, enabled, variant, receiver_qualifier, receiver_id, component_separator, segment_suffix, envelope_version, gs_functional_code, gs_sender_code, file_prefix, item_reference) VALUES (2784, '856', 1, 'arconic', '01', '961613887', '>', '', '00401', 'SH', 'R0P7ATN', 'S_arconic_856_', NULL);
COMMIT;
